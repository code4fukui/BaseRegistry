...
BaseRegistryは、様々な行政サービスや機関全体で使用される権威あるデータソースであるベース・レジストリを管理するためのフレームワークを提供する、日本のオープンソースプロジェクトです。
...
- [行政基本情報データ連携モデル-日付及び時刻](行政基本情報データ連携モデル-日付及び時刻.md)
- [行政基本情報データ連携モデル-住所](行政基本情報データ連携モデル-住所.md)
- [行政基本情報データ連携モデル-郵便番号](行政基本情報データ連携モデル-郵便番号.md)
- [行政基本情報データ連携モデル-地理情報](行政基本情報データ連携モデル-地理情報.md)
- [行政基本情報データ連携モデル-電話番号](行政基本情報データ連携モデル-電話番号.md)
- [行政基本情報データ連携モデル-POIコード](行政基本情報データ連携モデル-POIコード.md)
- [POIコード一覧](POIコード.csv)
...
- [コード一覧](コード一覧.csv) [※インターネット検索より整理](https://cio.go.jp/codes)
...
[Deno](https://deno.land) をインストールします。
```
cd deno
deno run -A make.js
```
